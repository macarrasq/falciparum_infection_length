...
original_unique<-df ## this is for the following plot of all unique haplotypes across all individuals/timepoints
...
df_sorted <- df[order(as.numeric(as.character(df$Timepoint))), ] ## order dates as numeric 
