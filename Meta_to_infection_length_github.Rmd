...
# Extract relevant columns from the original data for metadata addition
...
# Combine metadata with the identified chunks
...
# Merge with original data based on Sample column
